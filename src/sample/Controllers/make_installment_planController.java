...
public class make_installment_planController {
    ...
    void initialize() {
        if(Init_Controller._company== null)
            nameLabel.setText("Installment_plan" + Init_Controller._client.getName() + Integer.toString(Init_Controller._client.getCredits().size()));
        else
            nameLabel.setText("Installment_plan" + Init_Controller._company.getName() + Integer.toString(Init_Controller._company.getCredits().size()));
